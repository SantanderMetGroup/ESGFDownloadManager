...
public class FileStatusInfoDialog extends JDialog {
    ...
    public FileStatusInfoDialog(FileDownloadStatus fileStatus, Frame parent) {
        ...
        rowData[0][0] = "File id: " + fileStatus.getInstanceID();
        rowData[1][0] = "Size: " + bytesToString(fileStatus.getTotalSize());
        rowData[2][0] = "Path: " + fileStatus.getFilePath();
        rowData[3][0] = "Current download URL: "
                + fileStatus.getCurrentFileReplica().getUrlEndPointOfService(
                        Service.HTTPSERVER);
